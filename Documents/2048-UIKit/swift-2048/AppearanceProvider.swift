...
class AppearanceProvider: AppearanceProviderProtocol {
    ...
    func tileColor(_ value: Int) -> UIColor {
        ...
        case 256:
            return UIColor(red: 237.0/255.0, green: 207.0/255.0, blue: 100/255.0, alpha: 1.0)
        case 512:
            return UIColor(red: 237.0/255.0, green: 195/255.0, blue: 70/255.0, alpha: 1.0)
        case 1024:
            return UIColor(red: 237.0/255.0, green: 185/255.0, blue: 55/255.0, alpha: 1.0)
        case 2048:
            return UIColor(red: 237.0/255.0, green: 175/255.0, blue: 40/255.0, alpha: 1.0)
        default:
